...
国内 eSIM 基本处于残废状态，换卡需要去营业厅，还经常换卡不成功。国行 iPhone 只能写入 2 张 eSIM 卡，一旦出国旅行就无法写入第 3 张，得删掉一张等回来再去营业厅，非常不方便。iPhone 18 以后 Apple 有可能不再提供双实体卡槽，本项目提前布局远程通话和短信方案。
...
# 或指定版本
docker pull ghcr.io/myleo1/simgo:1.0.1
```
